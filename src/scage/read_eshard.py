...
class ReadEshard:
    ...
    def __init__(self, n_profiling, n_validation, n_attack_evo, n_attack, file_path, first_sample=0, number_of_samples=1400, is_desync=False, target_byte=15):
        self.name = "eshard"
        ...
        self.labels_key_hypothesis_attack_evo = None
    ...
    def load_dataset(self):
        ...
        profiling_samples = np.array(in_file['Profiling_traces/traces'])
        ...
        self.x_profiling = profiling_samples[:-self.n_validation, :self.ns]
        self.x_validation = profiling_samples[-self.n_validation:, :self.ns]
        self.x_attack_evo = attack_samples[:self.n_attack_evo, :self.ns]
        self.x_attack = attack_samples[self.n_attack_evo:self.n_attack_evo + self.n_attack, :self.ns]
