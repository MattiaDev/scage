...
class ReadASCAD:
    def __init__(self, n_profiling, n_validation, n_attack_evo, n_attack, fixed=True, file_path="", number_of_samples=700, is_desync=False, target_byte=2):
        ...
        self.correct_key = bytearray.fromhex(self.round_key)[self.target_byte]
